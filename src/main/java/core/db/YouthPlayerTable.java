...
public class YouthPlayerTable  extends AbstractTable {
    ...
    protected void initColumns() {
        var tmp = new ArrayList<>(List.of(
                ...
                ColumnDescriptor.Builder.newInstance().setColumnName("Specialty").setGetter((p) -> Specialty.getValueNullSafe(((YouthPlayer) p).getSpecialty())).setSetter((p, v) -> ((YouthPlayer) p).setSpecialty(Specialty.fromValueNullSafe((Integer) v))).setType(Types.INTEGER).isNullable(true).build(),
