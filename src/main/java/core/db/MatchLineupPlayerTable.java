...
public final class MatchLineupPlayerTable extends AbstractTable {
	...
	protected void initColumns() {
		columns = new ColumnDescriptor[]{
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("VName").setGetter((o) -> ((MatchLineupPosition) o).getFirstName()).setSetter((o, v) -> ((MatchLineupPosition) o).setFirstName((String) v)).setType(Types.VARCHAR).setLength(255).isNullable(false).build(),
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("Name").setGetter((o) -> ((MatchLineupPosition) o).getLastName()).setSetter((o, v) -> ((MatchLineupPosition) o).setLastName((String) v)).setType(Types.VARCHAR).setLength(255).isNullable(false).build(),
