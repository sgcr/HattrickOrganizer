...
public class YouthScoutCommentTable extends AbstractTable {
    ...
    protected void initColumns() {
        columns = new ColumnDescriptor[]{
                ...
                ColumnDescriptor.Builder.newInstance().setColumnName("SkillType").setGetter((p) -> Skills.ScoutCommentSkillTypeID.valueNullSafe(((ScoutComment) p).getSkillType())).setSetter((p, v) -> ((ScoutComment) p).setSkillType(Skills.ScoutCommentSkillTypeID.valueOf((Integer) v))).setType(Types.INTEGER).isNullable(true).build(),
